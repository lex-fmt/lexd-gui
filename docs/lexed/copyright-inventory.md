...
Almost everything in the repo is _licensed_ to us — GPL-3.0-or-later,
...
- A normalizer script that rewrites viewBox to `0 0 16 16`, rescales
  stroke-width to 1.2 _after_ the transform, and **preserves
...
File-type icons: an icon-theme _extension_ can restyle file icons (Material
