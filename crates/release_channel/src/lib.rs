...
pub fn app_identifier() -> &'static str {
    match *RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Lexed-Editor-Dev",
        ReleaseChannel::Nightly => "Lexed-Editor-Nightly",
        ReleaseChannel::Preview => "Lexed-Editor-Preview",
        ReleaseChannel::Stable => "Lexed-Editor-Stable",
    }
}
...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "Lexed Dev",
            ReleaseChannel::Nightly => "Lexed Nightly",
            ReleaseChannel::Preview => "Lexed Preview",
            ReleaseChannel::Stable => "Lexed",
        }
    }
    ...
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "ing.lex.Lexed-Dev",
            ReleaseChannel::Nightly => "ing.lex.Lexed-Nightly",
            ReleaseChannel::Preview => "ing.lex.Lexed-Preview",
            ReleaseChannel::Stable => "ing.lex.Lexed",
        }
    }
