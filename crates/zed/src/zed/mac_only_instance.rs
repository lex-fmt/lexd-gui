...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Lexed Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Lexed Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Lexed Editor Preview Instance Running",
        ReleaseChannel::Stable => "Lexed Editor Stable Instance Running",
    }
}
